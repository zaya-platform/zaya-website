// Encode PNG frames -> H.264 (High, yuv420p, CRF 18, +faststart). Also builds the 15 s cutdown,
// the poster frame and the review contact sheet.  node encode.mjs --frames out/frames --fps 60 --out deliverables
